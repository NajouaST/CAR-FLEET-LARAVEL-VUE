...
function openNew() {
    ...
    marqueDialog.value = true;
}

function hideDialog() {
    marqueDialog.value = false;
    submitted.value = false;
}
...
// only append if it's truthy; avoid instanceof
            ...
            <div class="card">
                ...
                >
                    ...
                    <Column header="Image" field="image_url">
                        <template #body="{ data }">
                            <img v-if="data.image_url" :src="data.image_url" class="rounded" style="height: 4rem" />
                        </template>
                    </Column>
                ...
                <!-- Create/Edit Dialog -->
                <Dialog v-model:visible="marqueDialog" :style="{ width: '600px' }" header="Marque Details" modal>
                    <div class="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <img v-if="marque.imagePreview || marque.image_url" :src="marque.imagePreview || marque.image_url"
                    ...
                    <template #footer>
                        ...
                        <Button label="Save" icon="pi pi-check" @click="saveMarque" />
                    </template>
                </Dialog>
