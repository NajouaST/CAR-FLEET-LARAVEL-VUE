...
async function savePersonnel() {
    ...
    saving.value = true;
    try {
        await paramsGenereauxStore.updatePersonnel(personnel.value.id, personnel.value, toast);
        toast.add({ severity: "success", summary: "Success", detail: "Personnel updated", life: 3000 });
        return;
    } catch (error) {
        console.error('Error updating personnel:', error);
        toast.add({ severity: "error", summary: "Error", detail: "Error updating personnel", life: 3000 });
